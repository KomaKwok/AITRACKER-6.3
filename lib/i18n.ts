...
export const dictionary = {
  zh: {
    ...
    dashboard: {
      ...
      paperTitle: "\u4eca\u65e5 AI \u8bba\u6587\u7cbe\u9009",
      paperDescription: "\u5408\u5e76 Hugging Face \u793e\u533a\u70ed\u5ea6\u4e0e arXiv \u6700\u65b0 AI \u8bba\u6587\uff0c\u53bb\u91cd\u540e\u5c55\u793a 10 \u7bc7\uff1b\u672c\u8f6e\u65e0\u7ed3\u679c\u65f6\u4fdd\u7559\u4e0a\u4e00\u6279\u6210\u529f\u5185\u5bb9\u3002",
      todayWeekTitle: "\u8fd1\u671f\u52a8\u6001",
      todayWeekDescription: "\u4f18\u5148\u5c55\u793a 7 \u5929\u5185\u65b0\u95fb\uff1b\u4e0d\u8db3 6 \u6761\u65f6\u4ece\u8fd1 180 \u5929\u7684\u5df2\u9a8c\u8bc1\u5386\u53f2\u4e2d\u56de\u8865\u3002",
      radarTitle: "\u91cd\u70b9\u96f7\u8fbe",
      radarDescription: "优先近期一手动态，再参考相关性评分；不足时回补至 90 天。展示原始发布日期，不固定置顶特定模型。",
    ...
    methodPage: {
      ...
      loopTitle: "\u6301\u7eed\u8ffd\u8e2a\u95ed\u73af",
      loopBody:
        "\u7edf\u4e00\u7684\u670d\u52a1\u7aef\u6d41\u6c34\u7ebf\u8d1f\u8d23\u6293\u53d6\u3001\u89e3\u6790\u3001\u5f52\u4e00\u5316\u3001\u53bb\u91cd\u3001\u6253\u6807\u7b7e\u3001\u6458\u8981\u3001\u8bc4\u5206\u4e0e\u6301\u4e45\u5316\u3002\u624b\u52a8\u5237\u65b0\u4e0e\u5b9a\u65f6\u4efb\u52a1\u5171\u7528\u540c\u4e00\u5957\u80fd\u529b\u3002",
      refTitle: "\u8bc4\u5206\u53c2\u8003",
  ...
  en: {
    ...
    dashboard: {
      ...
      paperTitle: "Today's AI Paper Picks",
      paperDescription: "Combines Hugging Face community momentum with recent arXiv AI papers, deduplicates them, and keeps 10 picks plus the last successful batch on empty refreshes.",
      todayWeekTitle: "Recent updates",
      todayWeekDescription: "Prioritizes the last 7 days and backfills from verified history up to 180 days when fewer than six items are available.",
      radarTitle: "Priority Radar",
      radarDescription: "Prioritizes recent first-hand updates, then relevance; backfills up to 90 days with original publication dates and no model-specific pinning.",
    ...
    methodPage: {
      ...
      loopBody:
        "A shared server-side pipeline handles fetch, parse, normalize, dedupe, tag, summarize, score, and durable persistence. The same refresh route supports manual refresh and cron-based runs.",
